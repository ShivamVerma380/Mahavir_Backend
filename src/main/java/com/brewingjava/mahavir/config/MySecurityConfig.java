...
public class MySecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http
                ...
                .disable()
                .authorizeRequests()
                .antMatchers("/add-user","/get-offers","/add-admin","/verify-email/{email}","/login-user","/get-categories","/get-cart-details","/get-products","/get-products/{modelNumber}").permitAll() //one doubt of image returning
