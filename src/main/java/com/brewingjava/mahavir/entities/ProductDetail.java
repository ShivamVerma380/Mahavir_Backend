...
public class ProductDetail {
    ...
    public ProductDetail(String modelNumber, String productName, String productDescription, Binary productImage1,
            Binary productImage2, Binary productImage3, Binary productImage4, Binary productImage5, String productPrice,
            String productCategory, String productSubCategory, String productVideoLink, String productVideo) {
    ...
    public String toString() {
        return "ProductsDetails [modelNumber=" + modelNumber 
